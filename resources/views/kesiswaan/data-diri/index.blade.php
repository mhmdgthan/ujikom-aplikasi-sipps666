...
@section('title', 'Data Diri Kesiswaan')
@section('page-title', 'Data Diri Kesiswaan')
    ...
    <div class="profile-card">
        <div class="profile-header">
            ...
            <div class="profile-info">
                <div class="profile-name">{{ $user->nama_lengkap ?? 'Staff Kesiswaan' }}</div>
                <div class="profile-role">Staff Kesiswaan</div>
        ...
        <div class="stats-grid">
            ...
            <div class="stat-card">
                ...
                <span class="stat-label">Pelanggaran Bulan Ini</span>
            </div>
        </div>
