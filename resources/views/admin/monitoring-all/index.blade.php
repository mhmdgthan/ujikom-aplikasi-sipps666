...
<div class="content-wrapper">
    ...
    <!-- Filter Form -->
    <form method="GET" action="{{ route('admin.monitoring-all.index') }}" class="mb-4">
        <div class="row g-3 align-items-end">
            ...
            <div class="col-md-4">
                ...
                <a href="{{ route('admin.monitoring-all.index') }}" class="btn btn-secondary me-2">
...
function searchTable() {
    ...
    for (let i = 1; i < rows.length; i++) {
        ...
        if (text.includes(filter) && matchesType) {
            row.style.display = '';
        } else {
...
function filterByType() {
    // Function removed as filtering is now handled server-side
}
...
function exportPdf() {
    ...
    let url = '{{ route("admin.monitoring-all.export-pdf") }}?';
