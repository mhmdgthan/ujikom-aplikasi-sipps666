...
class SanksiController extends Controller
{
    ...
    {
        $sanksi = Sanksi::with(['pelanggaran.siswa.user', 'pelanggaran.siswa.kelas'])->latest()->paginate(10);
        $pelanggaran = \App\Models\Pelanggaran::with(['siswa.user', 'siswa.kelas'])->get();
        $jenisSanksi = JenisSanksi::all();
        return view('kesiswaan.sanksi.index', compact('sanksi', 'pelanggaran', 'jenisSanksi'));
    }
