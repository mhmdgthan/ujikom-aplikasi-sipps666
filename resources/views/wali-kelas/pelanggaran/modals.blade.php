{{-- Modal Tambah Pelanggaran untuk WALI KELAS --}}
<div class="modal fade" id="tambahPelanggaranModal" tabindex="-1">
    <div class="modal-dialog modal-lg modal-dialog-scrollable">
        <div class="modal-content" style="border: none; border-radius: 12px; overflow: hidden;">
            ...
            <form action="{{ route('wali-kelas.pelanggaran.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="modal-body" style="padding: 24px;">
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <input type="file" name="bukti_foto" class="form-control" style="width: 100%; height: 40px; padding: 8px 14px; border: 1px solid #e2e8f0; border-radius: 8px; font-size: 13px; transition: all 0.2s;" accept="image/*">
                            <small style="color: #718096; font-size: 12px; margin-top: 4px; display: block;">Format: JPG, PNG, JPEG. Maksimal 2MB</small>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-body" style="padding: 24px;">
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            <label class="form-label" style="font-size: 13px; font-weight: 600; color: #4a5568; margin-bottom: 8px; display: block;">Bukti Foto (Opsional)</label>
                            <input type="file" name="bukti_foto" class="form-control" style="width: 100%; height: 40px; padding: 8px 14px; border: 1px solid #e2e8f0; border-radius: 8px; font-size: 13px; transition: all 0.2s;" accept="image/*">
                            <small style="color: #718096; font-size: 12px; margin-top: 4px; display: block;">Format: JPG, PNG, JPEG. Maksimal 2MB. Kosongkan jika tidak ingin mengubah foto</small>
                        </div>
                    </div>
                </div>
                <div class="modal-footer" style="padding: 16px 24px; border-top: 1px solid #f1f5f9;">
