...
@section('title', 'Data Diri BK')
@section('page-title', 'Data Diri Bimbingan Konseling')
    ...
    <div class="profile-card">
        <div class="profile-header">
            <div class="profile-avatar">
                {{ strtoupper(substr($user->nama_lengkap ?? 'B', 0, 1)) }}
            </div>
            <div class="profile-info">
                <div class="profile-name">{{ $user->nama_lengkap ?? 'Bimbingan Konseling' }}</div>
                <div class="profile-role">Bimbingan Konseling</div>
        ...
        <div class="stats-grid">
            <div class="stat-card">
                <span class="stat-value">{{ $totalKonseling ?? 0 }}</span>
                <span class="stat-label">Total Konseling</span>
            </div>
            <div class="stat-card">
                <span class="stat-value">{{ $konselingBulanIni ?? 0 }}</span>
                <span class="stat-label">Konseling Bulan Ini</span>
            </div>
            <div class="stat-card">
                <span class="stat-value">{{ $konselingSelesai ?? 0 }}</span>
                <span class="stat-label">Konseling Selesai</span>
            </div>
        </div>
