...
@section('title', 'Data Diri Kepala Sekolah')
@section('page-title', 'Data Diri Kepala Sekolah')
    ...
    <div class="profile-card">
        <div class="profile-header">
            ...
            <div class="profile-info">
                <div class="profile-name">{{ $user->nama_lengkap ?? 'Kepala Sekolah' }}</div>
        ...
        <div class="stats-grid">
            <div class="stat-card">
                <span class="stat-value">{{ $totalSiswa ?? 0 }}</span>
                <span class="stat-label">Total Siswa</span>
            </div>
            <div class="stat-card">
                <span class="stat-value">{{ $totalGuru ?? 0 }}</span>
                <span class="stat-label">Total Guru</span>
            </div>
            <div class="stat-card">
                <span class="stat-value">{{ $totalKelas ?? 0 }}</span>
