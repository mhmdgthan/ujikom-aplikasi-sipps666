...
<div class="content-wrapper">
    ...
    <!-- Filter Form -->
    <form method="GET" action="{{ route('kesiswaan.monitoring-all.index') }}" class="mb-4">
        <div class="row g-3 align-items-end">
            ...
            <div class="col-md-4">
                ...
                <a href="{{ route('kesiswaan.monitoring-all.index') }}" class="btn btn-secondary me-2">
...
function exportPdf() {
    ...
    let url = '{{ route("kesiswaan.monitoring-all.export-pdf") }}?';
